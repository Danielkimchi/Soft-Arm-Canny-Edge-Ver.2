...
//Camera Feed Function
	...
	cv::VideoCapture capWebcamA(1);            // declare a VideoCapture object and associate to webcam, 0 => use 1st webcam
	cv::VideoCapture capWebcamB(2);            //If needed, can change webcam feed (useful as Softarm project may use different webcam)
...
//////////////////////////////////////////////////////////////////////////////////////////////////
	...
	while (charCheckForEscKey != 27 && capWebcamA.isOpened() && capWebcamB.isOpened()) {            // until the Esc key is pressed or webcam connection is lost
		...
		cv::GaussianBlur(imgGrayscaleA,              // input image (should be "imgGrayscale")
			...
			1.8);                      // sigma value, determines how much the image will be blurred (suggested value is "1.8")
		...
		cv::Canny(imgBlurredA,                       // input image
			...
			20,                               // low threshold (suggested value is "50")
			20);                             // high threshold (suggested value is "100")
...
/////////////////////////////////////////////////////////////////////////////////////////////////        
     ...
     // Declare Windows and Images inside Windows
		...
		cv::imshow("imgOriginalB", imgOriginalA);                 // show the original webcam feed
